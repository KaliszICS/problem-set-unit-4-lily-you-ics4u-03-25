 ...
 * This class contains methods that return the name and suit of the card in a readable format and compares if two cards are equal.
 * 
 * @author Lily You
 * @version 1.6
 */
...
public class Card{
     ...
     * @param value int - the value of the card that represents the hierarchy of the cards(Ex: 2, 3, 4, 5, 6).
     */
